...
class BreakingNewsPage extends StatefulWidget {
  ...
  @override
  BreakingNewsPageListRow createState() => BreakingNewsPageListRow();
}

class BreakingNewsPageListRow extends State<BreakingNewsPage> {
  DashboardPageController dashboardPageController =
      Get.find<DashboardPageController>();
  BreakingNewsPageController controller =
      Get.find<BreakingNewsPageController>();
